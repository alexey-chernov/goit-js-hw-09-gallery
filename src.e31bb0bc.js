...
},{"./../images/icon-close.svg":[["icon-close.1add023a.svg","images/icon-close.svg"],"images/icon-close.svg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/images.js":[function(require,module,exports) {
"use strict";
...
var _images = _interopRequireDefault(require("./js/images.js"));
...
const imagesCardsMarkup = makeImageCard(_images.default);
...
function onNavigationKeysPress(event) {
  ...
  const imagesLength = _images.default.length;
  ...
  if (event.code === 'ArrowRight') {
    ...
    refs.lightboxImg.src = _images.default[newIndexIncr].original;
    refs.lightboxImg.alt = _images.default[newIndexIncr].description;
  ...
  if (event.code === 'ArrowLeft') {
    ...
    refs.lightboxImg.src = _images.default[newIndexDecr].original;
    refs.lightboxImg.alt = _images.default[newIndexDecr].description;
...
},{"./sass/main.scss":"sass/main.scss","./js/images.js":"js/images.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
